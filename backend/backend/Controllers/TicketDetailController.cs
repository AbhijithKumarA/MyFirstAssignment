...
namespace backend.Controllers
{
    ...
    public class TicketDetailController : ControllerBase
    {
        ...
        public TicketDetailController(TicketDetailContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TicketDetail>> PostTicketDetail(TicketDetail ticketDetail)
        {
            ...
            return CreatedAtAction("GetTicketDetail", new { id = ticketDetail.Ticketid }, ticketDetail);
        }
        ...
        {
            return _context.TicketDetails.Any(e => e.Ticketid == id);
        }
    }
}
